...
Après plusieurs mois d'expérience à l'utiliser dans de nombreuses conditions, voici **mes conseils pour régler et utiliser la** [**GoPro HERO5**](http://amzn.to/2hwuzei). Entre nouvelles fonctionnalités grand public et mise à jour plus avancée, tour d'horizon de ce qui change avec la HERO5 pour apprivoiser cette nouvelle caméra.

_(Mise à jour : Cet article est également valable pour la plupart des conseils avec la [**HERO6**](http://amzn.to/2juWEIW) et la [**HERO7**](https://amzn.to/2KDxpku). )_

Si la **HERO5 conserve beaucoup de points communs avec sa petite soeur la HERO4**, elle vient tout de même avec son lot de nouveautés à ne pas négliger et à apprendre à maîtriser. Elle est compatible (comme chaque caméra) avec environ 90% de l'écosystème GoPro, en dehors des accessoires dédiés aux autres modèles, la **HERO5 est compatible avec la quasi totalité des fixations** puisqu'elle possède la même base de 2 pattes qui viennent se loger dans les fentes des fixations habituelles GoPro. En revanche les batteries et les caissons étanches sont différents des HERO4 en format et l'**autonomie a été grandement amélioré** avec des nouvelles batteries sur la HERO5.

![](images/GoProStreamHeader.jpg)

**Étanche**

Étanche sans caisson jusqu'à une profondeur de 10m, la **HERO5** a aussi un **[caisson étanche à 60m](http://amzn.to/2ihbroz)** compatible (à acheter séparément) qui permet d'emmener la GoPro lors de plongées plus profondes. Attention toutefois, la HERO5 et les HERO4 ou 3 n'ont pas la même forme et les caissons étanches ne sont donc pas compatibles.

**Écran tactile**

Auparavant avec la gamme **HERO4**, on devait faire un choix entre avoir l'écran tactile intégré sur la _HERO4 Silver_ mais ne pas pouvoir filmer en 4K ou l'inverse avec la _HERO4 Black_ en pouvant filmer en 4K et ne pas avoir d'écran intégré.

La gamme de la HERO5 est désormais simplifiée avec _**la HERO5 Black qui réunit à la fois l'écran tactile de 2", la vidéo 4K et tout un tas de fonctionnalités anciennes et nouvelles**_.

La [**HERO5 Session**](http://amzn.to/2h88DVR) fait quant à elle la même taille que la HERO Session mais est aujourd'hui surpuissante pour sa taille puis qu'elle bénéficie elle aussi de la **stabilisation électronique, de la 4K** et de nombre de nouvelles fonctions.

L'écran tactile de la **[HERO5 Black](http://amzn.to/2hwuzei)** permet de contrôler l'ensemble de la caméra :
...
La liste des commandes vocales est assez robotique mais one peut ajouter des articles, au lieu de _"GoPro prendre photo_" la caméra reconnait aussi si on dit "_GoPro prends une photo._"

![](images/israelNeguev_17.jpg)![](images/GOPR0054.jpg)![](images/GOPR0297-2.jpg)
...
En activant ce réglage, l'angle de vue se retrouve plus ou moins le même que l'angle medium et la GoPro corrige d'elle même l'effet de déformation. Le linear est présent en vidéo mais aussi en photo. En revanche la **photo raw et le mode linear ne sont pas compatibles**, c'est soit l'un soit l'autre. En linear, la GoPro exporte la photo en .jpg. En activant ce mode, on ne peut donc pas avoir le très grand angle de la GoPro et les lignes non déformées, c'est tout simplement impossible dans n'importe quel appareil photo.
...
(effet Linéaire qui permet de supprimer l'effet fisheye)
...
**Blocage ISO + Exposition manuelle**

Avec la HERO5, on peut désormais **bloquer les ISO et régler la vitesse d'obturation** de la caméra manuellement, une fonction que beaucoup de gens n'ont que peu d'intérêt à utiliser mais dont les utilisateurs les plus avancés se réjouiront s'ils sont en quête de contrôle total pour notamment utiliser la GoPro dans des valeurs qui permettent d'obtenir un flou de mouvement en filmant.
...
![](images/HERO5.jpg)![](images/israelNeguev_39.jpg)

**Pour aller plus loin**

Un bon mode vidéo passe partout est le mode **1080 60** avec la **stabilisation vidéo activée** pour avoir une belle qualité d'image et la possibilité de faire des ralentis.
